...
<div class="h-fit m-5">
 ...
 @foreach ($ingredents as $ingredent)
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 pt-5 border p-3 mt-5" >
                <div class="col-span-5 flex justify-between">
                    <x-select label="Feed Type" placeholder-value="" placeholder="Select Feed Type" :options="$farms" option-value="id" option-label="farm_name" inline />
                    <div>
